...
map<const string, weak_ptr<DataReader<AnnotatedDatum>::Body> >
  ...
  = map<const string, weak_ptr<DataReader<AnnotatedDatum>::Body> >();
    ...
    template <>
    map<const string, weak_ptr<DataReader<SegDatum>::Body> >
            DataReader<SegDatum>::bodies_
            = map<const string, weak_ptr<DataReader<SegDatum>::Body> >();
    template <>
    map<const string, weak_ptr<DataReader<BBoxSegDatum>::Body> >
            DataReader<BBoxSegDatum>::bodies_
            = map<const string, weak_ptr<DataReader<BBoxSegDatum>::Body> >();
...
template class DataReader<AnnotatedDatum>;
    template class DataReader<SegDatum>;
    template class DataReader<BBoxSegDatum>;
