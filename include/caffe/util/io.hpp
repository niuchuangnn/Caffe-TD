...
bool ReadFileToDatum(const string& filename, const int label, Datum* datum);
    bool ReadFileToSegDatum(const string& filename, const int label, SegDatum* seg_datum);
...
bool ReadImageSegToSegDatum(const string& img_name, const string& seg_name, const int label,
                      const int height, const int width, const int min_dim, const int max_dim,
                      const bool is_color, const std::string & enc_img, const std::string& ecc_seg, SegDatum* seg_datum);
