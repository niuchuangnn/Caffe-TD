...
class DataTransformer {
 public:
  ...
  void CropImage(const Datum& datum, const NormalizedBBox& bbox,
                 Datum* crop_datum);
  void CropImageSeg(const SegDatum& seg_datum, const NormalizedBBox& bbox,
                 SegDatum* crop_datum);
    void UpdateBinaryMask(const AnnotationGroup& anno_group, SegDatum* seg_datum);
  ...
  void ExpandImage(const SegDatum& seg_datum, const float expand_ratio,
                   NormalizedBBox* expand_bbox, SegDatum* expanded_seg_datum);
  ...
  void DistortImage(const SegDatum& seg_datum, SegDatum* distort_seg_datum);
  ...
  void Transform(const cv::Mat& cv_img, Blob<Dtype>* transformed_blob);
        ...
        void Transform(const cv::Mat& cv_img, const cv::Mat& cv_seg, Blob<Dtype>* transformed_blob,
                       Blob<Dtype>* transformed_seg, NormalizedBBox* crop_bbox, bool* do_mirror);
  ...
  void ExpandImage(const cv::Mat& img, const float expand_ratio,
        ...
        void ExpandImageSeg(const cv::Mat& img, const cv::Mat& seg, const float expand_ratio,
                         NormalizedBBox* expand_bbox, cv::Mat* expand_img, cv::Mat* expand_seg);
  ...
  vector<int> InferBlobShape(const SegDatum& seg_datum);
  /**
   * @brief Infers the shape of transformed_blob will have when
   *    the transformation is applied to the data.
 ...
 protected:
  ...
  void Transform(const Datum& datum, Dtype* transformed_data);
        ...
        void Transform(const SegDatum& seg_datum, Dtype* transformed_data,
                       NormalizedBBox* crop_bbox, bool* do_mirror);
        void Transform(const SegDatum& seg_datum, Dtype* transformed_data);
