...
job_name = "SSD_{}".format("{}x{}".format(300, 300))
...
snapshot_dir = "/media/amax/data2/ssd_coco/models/VGGNet/coco/SSD_300x300"
...
net.data, net.label, net.seg = CreateBBoxDataLayer(train_data, batch_size=batch_size_per_device,
        train=True, is_object_mask=False, label_map_file=label_map_file,
        transform_param=train_transform_param, batch_sampler=batch_sampler)

net.__setattr__('seg_silence', L.Silence(net.seg, ntop=0))
...
net.data, net.label, net.seg = CreateBBoxDataLayer(test_data, batch_size=test_batch_size,
        train=False, is_object_mask=False, label_map_file=label_map_file,
        transform_param=test_transform_param)
