...
def vgg16_ssd_seg(source, bbox_seg_data_param, kwargs, use_batchnorm=False, lr_mult=1, extra_crop_layers=[]):
        ...
        DeVGGNetBody(net, from_layer='deconv6_1', fully_conv=True, reduced=True, dilated=True,
                     dropout=False, pool_mask=True, extra_crop_layers=extra_crop_layers)
...
if __name__ == "__main__":
        ...
        extra_crop_layers = ["conv3_3"]
        with open("vgg16_ssd_seg_noclass_extra3_3.prototxt", 'w') as f:
            f.write(str(vgg16_ssd_seg(source, bbox_seg_data_param, kwargs, extra_crop_layers=extra_crop_layers)))