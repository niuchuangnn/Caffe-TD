...
def vgg16_ssd_seg(source, bbox_seg_data_param, kwargs):
        ...
        net.cls_specific_bbox, net.binary_mask, net.cls = L.SelectBinary(net.bbox, net.seg, random_select=True, num_class=20, random_instance=False, ntop=3)
        return net.to_proto()
...
if __name__ == "__main__":
        ...
        with open("test_select_binary.prototxt", 'w') as f:
